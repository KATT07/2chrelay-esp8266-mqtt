...
// WiFi
const char *ssid = "FrenchFries"; // Enter your WiFi name
const char *password = "Lima@156";  // Enter WiFi password

// MQTT Broker
const char *mqtt_broker = "192.168.1.61";
const char *topic = "room1/relay";
const char *mqtt_username = "admin";
const char *mqtt_password = "adminpassword";
